...
```{r}
print(paste0("sbatch --mail-user=",email," 1_demux_barcode.sh ", container, " ", runfolder, " ", samplesheet," ", runtype))
```
...
print(paste0("sbatch --mail-user=",email, " 4_trim-adapter.sh ", container, " ", runres))
