#!/bin/bash
#SBATCH --job-name=5_dada2-se
#SBATCH --mem=64000
#SBATCH -n 2  # Number of cores
#SBATCH --out=reports/5_dada2-se-%j.out
#SBATCH --error=reports/5_dada2-se-%j.err
#SBATCH --mail-type=FAIL
#SBATCH --mail-type=END
#SBATCH --mail-user=blp23@duke.edu

# Usage: 5_dada2_single_ended.sh /marker-dir input output,  
...
# Run dada2
cd ~/scripts
Rscript 5_Rscript-echo.R 5_dada2_single_ended.R $1 $2 $3 
